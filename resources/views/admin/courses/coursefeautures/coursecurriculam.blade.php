        ...
        <div class="content-wrapper">
            <div class="content-header ">
                <div class="content-header-left ">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Course Curriculam
                                </li>
                    ...
                    <br>
                    <div>
                        <h3 class="content-header-title mb-0">Curriculum</h3>
                        <br>
                    </div>
                </div>
                ...
                <section id="configuration">
                    <div class="row">
                        ...
                        <div class="content-header-right col-md-5 col-12">
                            <h5>Add / Update Curriculum</h5>
                            <br>
                            <br>
                            <form class="validate1" name="curriculum-form" id="curriculum-form" method="POST">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="hidden" value="{{ $id ?? '' }}" name="course_id"
                                                id="course_id">
                                            <input type="hidden" name="course_curriculum_id" id="course_curriculam_id">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="answer">Description<SPAN
                                                    class="text-danger">*</SPAN></label>
                                            <textarea class="form-control editable summernote" rows="5" name="description"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#curriculam-table').DataTable({
                ...
                bjQueryUI: true,
                ajax: {
                    url: "{{ route('admin.coursecurriculam.index') }}",
                    data: {
                        "id": id
                    },
