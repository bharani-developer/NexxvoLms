        ...
        <div class="content-wrapper">
            <div class="content-header ">
                <div class="content-header-left ">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Course Faq
                                </li>
                    ...
                    <br>
                    <div>
                        <h3 class="content-header-title mb-0">Course Faq</h3>
                        <br>
                    </div>
                </div>
                ...
                <section id="configuration">
                    <div class="row">
                        <div class="col-7">
                            <div class="card">
                                <h5>Course Faq List</h5>
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">

                                        <table id="faq-table" class="table table-striped table-bordered zero-configuration">
                                            <thead>
                                                <tr>
                                                    <th>S.No</th>
                                                    <th>Heading</th>
                        ...
                        <div class="content-header-right col-md-5 col-12">
                            <h5>Add / Update Course Faq</h5>
                            <br>
                            <br>
                            <form class="validate1" action="#" id="faq-form" method="POST">

                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" value="{{ $id ?? '' }}" name="course_id" id="course_id">
                                        <input type="hidden" name="course_faq_id" id="course_faq_id">

                                        <div class="form-group">
                                            <label class="control-label" for="question">Heading<span
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="answer">Description<span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control summernote" rows="5" name="description" id="description"
                                                required></textarea>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#faq-table').DataTable({
                ...
                bjQueryUI: true,
                ajax: {
                    url: "{{ route('admin.coursefaq.index') }}",
                    data: {
                        "id": id
                    },
        ...
        $('#faq-form').on('submit', function(event) {
            ...
            let course_faq_id = $('#course_faq_id').val();
            let heading = $('#heading').val();
            let subject = $('#subject').val();
            let description = $('#description').val();
            console.log(course_id);
            $.ajax({
                url: "{{ route('admin.coursefaq.store') }}",
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
                    course_id: course_id,
                    course_faq_id: course_faq_id,
                    heading: heading,
                    subject: subject,
