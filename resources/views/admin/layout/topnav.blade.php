<!-- fixed-top-->
<nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-semi-dark navbar-shadow" data-nav="brand-left">
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-notification nav-item">
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list ps-container ps-theme-dark ps-active-y" data-ps-id="b2ccf6a3-5a87-fbd4-044a-dc32639385bf">
                  ...
                  <div class="ps-scrollbar-y-rail" style="top: 0px; height: 256px; right: 3px;">
                    <div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 163px;"></div>
                  </div>
                </li>
            ...
            <li class="dropdown dropdown-notification nav-item">
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list ps-container ps-theme-dark ps-active-y" data-ps-id="581e5e05-0edb-dac5-d048-3fd74b14ed7d">
                  <a href="javascript:void(0)">
                    <div class="media">
                  ...
                  <div class="ps-scrollbar-y-rail" style="top: 0px; height: 256px; right: 3px;">
                    <div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 192px;"></div>
                  </div>
                </li>
